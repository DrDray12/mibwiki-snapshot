...
After changing the firmware in your unit, there's a good chance that your navigation will no longer work like so:
 ...
 ![](attachments/eaeb86de-3ffc-4ab7-801f-142d6c68bacd.png)There are a few things that can cause problems like this, we'll fix all of them as needed!
...
More details about FEC/SWaP code structure can be found here: FEC/SWaP codes for VAG MIB2 & MIB3.
...
If it's missing, needs replacing or there are no codes at all, it's time to break out  M.I.B. - More Incredible Bash[ ](/en/MHI2)
