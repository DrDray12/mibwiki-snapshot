...
2. [Convert img to vmdk](https://mibwiki.one/doc/converting-img-to-vmdk-with-qemu-pOUhxTGwJY)
...
## Useful file locations (also see [here](https://mibwiki.one/doc/useful-file-locations-t38N6mfhuT))
